...
var dataset = [
  { label: 'Abulia', count: $scope.input1 },
  { label: 'Betelgeuse', count: $scope.input2 },
  { label: 'Cantaloupe', count: $scope.input3 },
  { label: 'Dijkstra', count: $scope.input4 }
];
...
var path = svgPie.selectAll('path')// select (for now non-existing) paths
    .data(pie(dataset)) // pass the data from the dataset through the D3 Pie() function
